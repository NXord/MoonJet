...
namespace MoonJet
{
    ...
    public class ScreenJeux : GameScreen
    {
        ...
        private float _chronoDif;
        private double _seuilDif;
        ...
        public ScreenJeux(Game1 game) : base(game)
        {
            _game1 = game;
        }
        ...
        public override void Initialize()
        {
            ...
            _positionMeteorite = new Vector2[5];
        ...
        public override void Update(GameTime gameTime)
        {
            ...
            _chronoDif += deltaTime;
            if (_chronoDif > _seuilDif && _positionMeteorite.Length<20)
            {
                if(_seuilDif>=1)
                    _seuilDif -= 0.5;
                Array.Resize(ref _positionMeteorite, _positionMeteorite.Length + 1);
                _positionMeteorite[_positionMeteorite.Length - 1] = new Vector2(GraphicsDevice.Viewport.Width, r.Next(0, GraphicsDevice.Viewport.Height - HAUTEUR_METEORITE));
                _rectangleMeteorite = new Rectangle((int)_positionMeteorite[_positionMeteorite.Length - 1].X, (int)_positionMeteorite[_positionMeteorite.Length - 1].Y, LARGEUR_METEORITE, HAUTEUR_METEORITE);
                _chronoDif = 0;
            }
